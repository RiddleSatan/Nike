...
const Footer = () => {
  return (
    <div className='w-full h-[60vh] bg-black flex justify-evenly items-center'>
        <div className='w-80 h-80 bg-black text-white flex-col  justify-self-start color   leading-6 '>
            ...
            <div className='w-full h-10 bg-black mt-7 flex justify-self-start gap-4'>
        ...
        <div className='w-60 h-80 bg-black flex flex-col  gap-3 text-white '>
